                    ...
                    <div className='my-4 flex gap-3'>
                        <div className='w-full max-w-3xl'>
                            {productCartItem.map((el, index) => {
                                return (
                                    <CartProduct key={index} image={el.image} name={el.name} category={el.category} price={el.price} qty={el.qty} total={el.total} />
                                )
                            })}
                        </div>
                        ...
                        <div className='flex w-full justify-center items-center flex-col'>
                            <img src={emptyCart} className='w-full max-w-sm' alt='' />
