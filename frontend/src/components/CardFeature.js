...
const CardFeature = ({ image, name, price, category, loading, id }) => {
    ...
    return (
        <div className='w-full min-w-[200px] max-w-[200px] bg-white hover:drop-shadow-lg cursor-pointer py-5 px-4 flex flex-col'>
            {
                image ? <>
                    ...
                    <button className='bg-yellow-500 py-1 my-2 rounded hover:bg-yellow-600 w-full' onClick={handleAddtoCart}>Add to Cart</button>
